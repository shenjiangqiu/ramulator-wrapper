extern "C" {
    ...
    pub(super) fn ramulator_send(ramulator: *mut libc::c_void, addr: u64, is_write: libc::c_int);
    ...
    pub(super) fn ramulator_ret_available(ramulator: *mut libc::c_void) -> libc::c_int;
